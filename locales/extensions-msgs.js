...
export default {
  ...
  "en": {
    ...
    "MicrobiteIcreateS4S.ICM_S4S_ambient": "atmosphere lamp brightness [CHOICE] color [COL]",
    ...
    "MicrobiteIcreateS4S.ICM_S4S_ultrSet": "set brightness [CHOICE] color [COL]",
    ...
    "MicrobiteIcreateS4S.ICM_S4S_grayGet": "probe [CHOICE] grayscale value",
    "MicrobiteIcreateS4S.ICM_S4S_colorGet": "probe [CHOICE] recognized [CHOICE1]?",
    "MicrobiteIcreateS4S.ICM_S4S_blackGet": "probe [CHOICE] detect black line?",
    ...
    "LinkBot.ICM_S4S_motorRunType": "motor [CHOICE] run [DIVERSION] for [NUM] [TYPE]",
    "LinkBot.ICM_S4S_motorRunDiv": "motor [CHOICE] start motor [DIVERSION]",
    "LinkBot.ICM_S4S_motorStop": "motor [CHOICE] stop motor",
    "LinkBot.ICM_S4S_motorSetSpeed": "motor [CHOICE] set speed to [NUM]",
    "LinkBot.ICM_S4S_motorGetPos": "motor [CHOICE] position",
    "LinkBot.ICM_S4S_motorGetSpeed": "motor [CHOICE] speed",
    "LinkBot.ICM_S4S_motorSetPos": "motor [CHOICE] set relative position to 0",
    "LinkBot.ICM_S4S_motorRunPower": "motor [CHOICE] start motor at [NUM]% power",
    "LinkBot.ICM_S4S_motorGetPower": "motor [CHOICE] power",
    ...
    "LinkBot.ICM_S4S_MovSetPow": "start moving at [P1] [P2] speed",
  ...
  "zh-cn": {
    ...
    "MicrobiteIcreateS4S.ICM_S4S_ambient": "氛围灯 亮度[CHOICE]颜色[COL]",
    ...
    "MicrobiteIcreateS4S.ICM_S4S_ultrSet": "设置灯环亮度[CHOICE]颜色[COL]",
